...
const Card1 = () => {
  return (
    <div
      className="absolute w-[22.021vw] h-[20.05vw] left-[29.5vw] top-[50.8vw] bg-white rounded-[1vw] group transition-all duration-300 ease-out hover:scale-105 hover:-translate-y-3 cursor-pointer"
      style={{
