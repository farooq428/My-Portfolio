  ...
  return (
    ...
    >
      <div className="absolute w-[4.3vw] h-[4.3vw] left-1/2 -translate-x-1/2 top-[2vw] bg-white rounded-full shadow-lg flex items-center justify-center transition-all duration-300 group-hover:scale-110 group-hover:shadow-xl">
        <FaDatabase className="text-[3vw] text-purple-500 transition-all duration-500 group-hover:rotate-360 group-hover:text-purple-600" />
      </div>

      <h3 className="absolute font-['Raleway'] top-[8.5vw] left-1/2 -translate-x-1/2 font-normal text-[1.1vw] leading-[1vw] tracking-[-0.015em] text-black whitespace-nowrap transition-all duration-300 group-hover:text-purple-600">
      ...
      <p className="absolute w-[20.83vw] h-[6.6vw] top-[15vw] -translate-x-1/2 left-1/2 -translate-y-1/2 font-['Raleway'] font-extralight text-[1vw] leading-[150%] tracking-[0.05em] text-center text-black pl-4 pr-4 transition-all duration-300 group-hover:text-gray-700">
        Designing efficient database schemas, writing optimized queries, and ensuring data integrity with SQL and modern database systems.
      </p>
    </div>
  );
};
