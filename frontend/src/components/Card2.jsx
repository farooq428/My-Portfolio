...
const Card2 = () => {
  return (
    <div
      className="absolute w-[22.021vw] h-[20.05vw] left-[3.5vw] top-[80.8vw] bg-white rounded-[1vw] group transition-all duration-300 ease-out hover:scale-105 hover:-translate-y-3 cursor-pointer"
      style={{
    ...
    >
      <div className="absolute w-[4.3vw] h-[4.3vw] left-1/2 -translate-x-1/2 top-[2vw] bg-white rounded-full shadow-lg flex items-center justify-center transition-all duration-300 group-hover:scale-110 group-hover:shadow-xl">
        <FaNodeJs className="text-[3vw] text-green-500 transition-all duration-500 group-hover:rotate-360 group-hover:text-green-600" />
      </div>

      <h3 className="absolute font-['Raleway'] top-[8.5vw] left-1/2 -translate-x-1/2 font-normal text-[1.1vw] leading-[1vw] tracking-[-0.015em] text-black whitespace-nowrap transition-all duration-300 group-hover:text-green-600">
        BACKEND DEVELOPMENT
      </h3>
      ...
      <p className="absolute w-[20.83vw] h-[6.6vw] top-[15vw] -translate-x-1/2 left-1/2 -translate-y-1/2 font-['Raleway'] font-extralight text-[1vw] leading-[150%] tracking-[0.05em] text-center text-black pl-4 pr-4 transition-all duration-300 group-hover:text-gray-700">
        Building scalable server-side logic, RESTful APIs, and data processing with Node.js and modern backend technologies.
      </p>
    </div>
  );
};
