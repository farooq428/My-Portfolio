...
const Card2 = () => {
  return (
    <div
      className="absolute w-[22.021vw] h-[20.05vw] left-[3.5vw] top-[70.8vw] bg-white rounded-[1vw] group transition-all duration-300 ease-out hover:scale-105 hover:-translate-y-3 cursor-pointer"
      style={{
